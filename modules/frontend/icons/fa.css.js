...
export const facss = css`
    ...
    @font-face {
        ...
        src: url("./app/webfonts/fa-brands-400.eot?#iefix")
            ...
            url("./app/webfonts/fa-brands-400.svg#fontawesome") format("svg");
    }
    @font-face {
        ...
        src: url("./app/webfonts/fa-regular-400.eot?#iefix")
            ...
            url("./app/webfonts/fa-regular-400.svg#fontawesome") format("svg");
    }
    @font-face {
        font-family: "Font Awesome 5 Free";
        font-style: normal;
        ...
        src: url("./app/webfonts/fa-solid-900.eot?#iefix")
            ...
            url("./app/webfonts/fa-solid-900.svg#fontawesome") format("svg");
    }
    .fab {
        font-family: "Font Awesome 5 Brands";
    }
