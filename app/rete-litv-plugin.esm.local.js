...
import { BaseAreaPlugin } from "https://esm.sh/rete-area-plugin@2.0.0";
...
function setProps(element, payload) {
    for (
        var _i = 0, _Object$keys = Object.keys(payload);
...
function _update(instance, payload) {
    instance.payload = _objectSpread$5(
        _objectSpread$5({}, instance.payload),
        payload
    );
...
function _decorate$d(decorators, factory, superClass, mixins) {
    ...
    var decorated = api.decorateClass(
        _coalesceClassElements$d(r.d.map(_createElementDescriptor$d)),
        decorators
    );
...
function _getDecoratorsApi$d() {
    _getDecoratorsApi$d = function _getDecoratorsApi() {
        return api;
    };
    var api = {
        ...
        toElementFinisherExtras: function toElementFinisherExtras(
            ...
            var element = this.toElementDescriptor(elementObject);
            var finisher = _optionalCallableProperty$d(
                elementObject,
                "finisher"
            );
...
function _coalesceClassElements$d(elements) {
    ...
    for (var i = 0; i < elements.length; i++) {
        ...
        if (
            ...
            if (
                _isDataDescriptor$d(element.descriptor) ||
                _isDataDescriptor$d(other.descriptor)
            ) {
            ...
            d: [
                ...
                },
                {
                    ...
                    value: function value() {
                        return css(
                            _templateObject$f ||
                                (_templateObject$f = _taggedTemplateLiteral([
...
function _decorate$c(decorators, factory, superClass, mixins) {
    ...
    var decorated = api.decorateClass(
        _coalesceClassElements$c(r.d.map(_createElementDescriptor$c)),
        decorators
    );
    api.initializeClassElements(r.F, decorated.elements);
    return api.runClassFinishers(r.F, decorated.finishers);
...
function _getDecoratorsApi$c() {
    _getDecoratorsApi$c = function _getDecoratorsApi() {
        return api;
    };
    var api = {
        elementsDefinitionOrder: [["method"], ["field"]],
        ...
        toElementFinisherExtras: function toElementFinisherExtras(
            ...
            var element = this.toElementDescriptor(elementObject);
            var finisher = _optionalCallableProperty$c(
                elementObject,
                "finisher"
            );
            var extras = this.toElementDescriptors(elementObject.extras);
...
function _coalesceClassElements$c(elements) {
    ...
    for (var i = 0; i < elements.length; i++) {
        ...
        if (
            ...
            if (
                _isDataDescriptor$c(element.descriptor) ||
                _isDataDescriptor$c(other.descriptor)
            ) {
...
var ConnectionWrapper = _decorate$c(
            ...
            d: [
                ...
                },
                {
                    ...
                    value: function connectedCallback() {
                        _get(
                            _getPrototypeOf(ConnectionWrapper.prototype),
                            "connectedCallback",
                            this
                        ).call(this);
                ...
                },
                {
                    ...
                    key: "fetchPath",
                    value: (function () {
                        var _fetchPath = _asyncToGenerator(
...
function _decorate$b(decorators, factory, superClass, mixins) {
    ...
    var decorated = api.decorateClass(
        _coalesceClassElements$b(r.d.map(_createElementDescriptor$b)),
        decorators
    );
    api.initializeClassElements(r.F, decorated.elements);
    return api.runClassFinishers(r.F, decorated.finishers);
...
function _getDecoratorsApi$b() {
    _getDecoratorsApi$b = function _getDecoratorsApi() {
        return api;
    };
    var api = {
        elementsDefinitionOrder: [["method"], ["field"]],
        ...
        toElementFinisherExtras: function toElementFinisherExtras(
            ...
            var element = this.toElementDescriptor(elementObject);
            var finisher = _optionalCallableProperty$b(
                elementObject,
                "finisher"
            );
            var extras = this.toElementDescriptors(elementObject.extras);
...
function _coalesceClassElements$b(elements) {
    ...
    for (var i = 0; i < elements.length; i++) {
        ...
        if (
            ...
            if (
                _isDataDescriptor$b(element.descriptor) ||
                _isDataDescriptor$b(other.descriptor)
            ) {
            ...
            d: [
                    ...
                    value: function render() {
                        ...
                        return html(
                            ...
                            (_this$data = this.data) === null ||
                                ...
                                ? void 0
                                : _this$data.type,
                            (_this$data2 = this.data) === null ||
                                _this$data2 === void 0
                                ? void 0
                                : _this$data2.value,
                            (_this$data3 = this.data) === null ||
                                _this$data3 === void 0
                                ? void 0
                                : _this$data3.readonly,
                            this.change,
                            this.stopEvent
                        );
                    },
                },
                {
                    ...
                    value: function change(e) {
                        ...
                        var val =
                            ((_this$data4 = this.data) === null ||
                            _this$data4 === void 0
                                ? void 0
                                : _this$data4.type) === "number"
                                ? +((_e$target = e.target) === null ||
                                  _e$target === void 0
                                      ? void 0
                                      : _e$target.value)
                                : (_e$target2 = e.target) === null ||
                                  _e$target2 === void 0
                                ? void 0
                                : _e$target2.value;

                        // @ts-ignore
                        (_this$data5 = this.data) === null ||
                        _this$data5 === void 0
                            ? void 0
                            : _this$data5.setValue(val);
                    },
                },
                {
                    kind: "method",
...
function _decorate$a(decorators, factory, superClass, mixins) {
    ...
    var decorated = api.decorateClass(
        _coalesceClassElements$a(r.d.map(_createElementDescriptor$a)),
        decorators
    );
    api.initializeClassElements(r.F, decorated.elements);
    return api.runClassFinishers(r.F, decorated.finishers);
...
function _getDecoratorsApi$a() {
    _getDecoratorsApi$a = function _getDecoratorsApi() {
        return api;
    };
    var api = {
        elementsDefinitionOrder: [["method"], ["field"]],
        ...
        toElementFinisherExtras: function toElementFinisherExtras(
            ...
            var element = this.toElementDescriptor(elementObject);
            var finisher = _optionalCallableProperty$a(
                elementObject,
                "finisher"
            );
            var extras = this.toElementDescriptors(elementObject.extras);
...
function _coalesceClassElements$a(elements) {
    ...
    for (var i = 0; i < elements.length; i++) {
        ...
        if (
            ...
            if (
                _isDataDescriptor$a(element.descriptor) ||
                _isDataDescriptor$a(other.descriptor)
            ) {
                ...
                },
                {
                    ...
                    value: function render() {
                        ...
                        return html(
                            ...
                            (_this$data6 = this.data) !== null &&
                                _this$data6 !== void 0 &&
                                _this$data6.selected
                                ? "selected"
                                : "",
                            this.nodeStyles(),
                            (_this$data7 = this.data) === null ||
                                _this$data7 === void 0
                                ? void 0
                                : _this$data7.label,
                            this.outputs().map(function (_ref) {
                                var _this2$data;
                            ...
                            this.inputs().map(function (_ref5) {
                                ...
                                return html(
                                    ...
                                    key,
                                    {
                                        ...
                                        key: key,
                                        nodeId:
                                            (_this2$data2 = _this2.data) ===
                                                null || _this2$data2 === void 0
                                                ? void 0
                                                : _this2$data2.id,
...
function _decorate$9(decorators, factory, superClass, mixins) {
    ...
    var decorated = api.decorateClass(
        _coalesceClassElements$9(r.d.map(_createElementDescriptor$9)),
        decorators
    );
    api.initializeClassElements(r.F, decorated.elements);
    return api.runClassFinishers(r.F, decorated.finishers);
...
function _getDecoratorsApi$9() {
    _getDecoratorsApi$9 = function _getDecoratorsApi() {
        return api;
    };
    var api = {
        elementsDefinitionOrder: [["method"], ["field"]],
        ...
        toElementFinisherExtras: function toElementFinisherExtras(
            ...
            var element = this.toElementDescriptor(elementObject);
            var finisher = _optionalCallableProperty$9(
                elementObject,
                "finisher"
            );
            var extras = this.toElementDescriptors(elementObject.extras);
...
function _coalesceClassElements$9(elements) {
    ...
    for (var i = 0; i < elements.length; i++) {
        ...
        if (
            ...
            if (
                _isDataDescriptor$9(element.descriptor) ||
                _isDataDescriptor$9(other.descriptor)
            ) {
...
function setup$3(props) {
    var positionWatcher =
        typeof (props === null || props === void 0
            ? void 0
            : props.socketPositionWatcher) === "undefined"
            ? getDOMSocketPosition()
            : props === null || props === void 0
            ? void 0
            : props.socketPositionWatcher;
    var _ref =
            (props === null || props === void 0 ? void 0 : props.customize) ||
            {},
        node = _ref.node,
    ...
    return {
        ...
        render: function render(context, plugin) {
            ...
            if (context.data.type === "node") {
                ...
                return context.data.payload instanceof
...
function _decorate$8(decorators, factory, superClass, mixins) {
    ...
    var decorated = api.decorateClass(
        _coalesceClassElements$8(r.d.map(_createElementDescriptor$8)),
        decorators
    );
    api.initializeClassElements(r.F, decorated.elements);
    return api.runClassFinishers(r.F, decorated.finishers);
...
function _getDecoratorsApi$8() {
    _getDecoratorsApi$8 = function _getDecoratorsApi() {
        return api;
    };
    var api = {
        elementsDefinitionOrder: [["method"], ["field"]],
        ...
        toElementFinisherExtras: function toElementFinisherExtras(
            ...
            var element = this.toElementDescriptor(elementObject);
            var finisher = _optionalCallableProperty$8(
                elementObject,
                "finisher"
            );
            var extras = this.toElementDescriptors(elementObject.extras);
...
function _coalesceClassElements$8(elements) {
    ...
    for (var i = 0; i < elements.length; i++) {
        ...
        if (
            ...
            if (
                _isDataDescriptor$8(element.descriptor) ||
                _isDataDescriptor$8(other.descriptor)
            ) {
...
function _decorate$7(decorators, factory, superClass, mixins) {
    ...
    var decorated = api.decorateClass(
        _coalesceClassElements$7(r.d.map(_createElementDescriptor$7)),
        decorators
    );
    api.initializeClassElements(r.F, decorated.elements);
    return api.runClassFinishers(r.F, decorated.finishers);
...
function _getDecoratorsApi$7() {
    _getDecoratorsApi$7 = function _getDecoratorsApi() {
        return api;
    };
    var api = {
        elementsDefinitionOrder: [["method"], ["field"]],
        ...
        toElementFinisherExtras: function toElementFinisherExtras(
            ...
            var element = this.toElementDescriptor(elementObject);
            var finisher = _optionalCallableProperty$7(
                elementObject,
                "finisher"
            );
            var extras = this.toElementDescriptors(elementObject.extras);
...
function _coalesceClassElements$7(elements) {
    ...
    for (var i = 0; i < elements.length; i++) {
        ...
        if (
            ...
            if (
                _isDataDescriptor$7(element.descriptor) ||
                _isDataDescriptor$7(other.descriptor)
            ) {
    ...
    function (_initialize, _LitElement) {
        var Item = /*#__PURE__*/ (function (_LitElement2) {
            ...
            function Item() {
                ...
                _this.hide = debounce(
                    _this.delay,
                    _this.hideSubitems.bind(_assertThisInitialized(_this))
                );
                return _this;
            }
...
function _decorate$6(decorators, factory, superClass, mixins) {
    ...
    var decorated = api.decorateClass(
        _coalesceClassElements$6(r.d.map(_createElementDescriptor$6)),
        decorators
    );
    api.initializeClassElements(r.F, decorated.elements);
    return api.runClassFinishers(r.F, decorated.finishers);
...
function _getDecoratorsApi$6() {
    _getDecoratorsApi$6 = function _getDecoratorsApi() {
        return api;
    };
    var api = {
        elementsDefinitionOrder: [["method"], ["field"]],
        ...
        toElementFinisherExtras: function toElementFinisherExtras(
            ...
            var element = this.toElementDescriptor(elementObject);
            var finisher = _optionalCallableProperty$6(
                elementObject,
                "finisher"
            );
            var extras = this.toElementDescriptors(elementObject.extras);
...
function _coalesceClassElements$6(elements) {
    ...
    for (var i = 0; i < elements.length; i++) {
        ...
        if (
            ...
            if (
                _isDataDescriptor$6(element.descriptor) ||
                _isDataDescriptor$6(other.descriptor)
            ) {
...
function _decorate$5(decorators, factory, superClass, mixins) {
    ...
    var decorated = api.decorateClass(
        _coalesceClassElements$5(r.d.map(_createElementDescriptor$5)),
        decorators
    );
    api.initializeClassElements(r.F, decorated.elements);
    return api.runClassFinishers(r.F, decorated.finishers);
...
function _getDecoratorsApi$5() {
    _getDecoratorsApi$5 = function _getDecoratorsApi() {
        return api;
    };
    var api = {
        elementsDefinitionOrder: [["method"], ["field"]],
        ...
        toElementFinisherExtras: function toElementFinisherExtras(
            ...
            var element = this.toElementDescriptor(elementObject);
            var finisher = _optionalCallableProperty$5(
                elementObject,
                "finisher"
            );
            var extras = this.toElementDescriptors(elementObject.extras);
...
function _coalesceClassElements$5(elements) {
    ...
    for (var i = 0; i < elements.length; i++) {
        ...
        if (
            ...
            if (
                _isDataDescriptor$5(element.descriptor) ||
                _isDataDescriptor$5(other.descriptor)
            ) {
        ...
        return {
            ...
            d: [
                ...
                },
                {
                    ...
                    value: function connectedCallback() {
                        _get(
                            _getPrototypeOf(Menu.prototype),
                            "connectedCallback",
                            this
                        ).call(this);
                    },
...
function setup$2(props) {
    var delay =
        typeof (props === null || props === void 0 ? void 0 : props.delay) ===
        "undefined"
            ? 1000
            : props.delay;
    return {
...
function _decorate$4(decorators, factory, superClass, mixins) {
    ...
    var decorated = api.decorateClass(
        _coalesceClassElements$4(r.d.map(_createElementDescriptor$4)),
        decorators
    );
    api.initializeClassElements(r.F, decorated.elements);
    return api.runClassFinishers(r.F, decorated.finishers);
...
function _getDecoratorsApi$4() {
    _getDecoratorsApi$4 = function _getDecoratorsApi() {
        return api;
    };
    var api = {
        elementsDefinitionOrder: [["method"], ["field"]],
        ...
        toElementFinisherExtras: function toElementFinisherExtras(
            ...
            var element = this.toElementDescriptor(elementObject);
            var finisher = _optionalCallableProperty$4(
                elementObject,
                "finisher"
            );
            var extras = this.toElementDescriptors(elementObject.extras);
...
function _coalesceClassElements$4(elements) {
    ...
    for (var i = 0; i < elements.length; i++) {
        ...
        if (
            ...
            if (
                _isDataDescriptor$4(element.descriptor) ||
                _isDataDescriptor$4(other.descriptor)
            ) {
...
function _decorate$3(decorators, factory, superClass, mixins) {
    ...
    var decorated = api.decorateClass(
        _coalesceClassElements$3(r.d.map(_createElementDescriptor$3)),
        decorators
    );
    api.initializeClassElements(r.F, decorated.elements);
    return api.runClassFinishers(r.F, decorated.finishers);
...
function _getDecoratorsApi$3() {
    _getDecoratorsApi$3 = function _getDecoratorsApi() {
        return api;
    };
    var api = {
        elementsDefinitionOrder: [["method"], ["field"]],
        ...
        toElementFinisherExtras: function toElementFinisherExtras(
            ...
            var element = this.toElementDescriptor(elementObject);
            var finisher = _optionalCallableProperty$3(
                elementObject,
                "finisher"
            );
            var extras = this.toElementDescriptors(elementObject.extras);
...
function _coalesceClassElements$3(elements) {
    ...
    for (var i = 0; i < elements.length; i++) {
        ...
        if (
            ...
            if (
                _isDataDescriptor$3(element.descriptor) ||
                _isDataDescriptor$3(other.descriptor)
            ) {
                ...
                },
                {
                    ...
                    value: function value() {
                        return function (_x, _y) {
                            throw new Error(
                                "TRANSLATE NOT SET PROPERLY IN MiniViewport"
                            );
                        };
                    },
                },
    ...
    if (createState) {
        return function isEqual(a, b) {
            var _a = createState(),
                _b = _a.cache,
                cache =
                    _b === void 0 ? (circular ? new WeakMap() : undefined) : _b,
                meta = _a.meta;
...
function _decorate$2(decorators, factory, superClass, mixins) {
    ...
    var decorated = api.decorateClass(
        _coalesceClassElements$2(r.d.map(_createElementDescriptor$2)),
        decorators
    );
    api.initializeClassElements(r.F, decorated.elements);
    return api.runClassFinishers(r.F, decorated.finishers);
...
function _getDecoratorsApi$2() {
    _getDecoratorsApi$2 = function _getDecoratorsApi() {
        return api;
    };
    var api = {
        elementsDefinitionOrder: [["method"], ["field"]],
        ...
        toElementFinisherExtras: function toElementFinisherExtras(
            ...
            var element = this.toElementDescriptor(elementObject);
            var finisher = _optionalCallableProperty$2(
                elementObject,
                "finisher"
            );
            var extras = this.toElementDescriptors(elementObject.extras);
...
function _coalesceClassElements$2(elements) {
    ...
    for (var i = 0; i < elements.length; i++) {
        ...
        if (
            ...
            if (
                _isDataDescriptor$2(element.descriptor) ||
                _isDataDescriptor$2(other.descriptor)
            ) {
            ...
            d: [
                ...
                },
                {
                    ...
                    value: function render() {
                        ...
                        return html(
                            ...
                            px(this.size * this.ratio),
                            px(this.size),
                            this.stopEvent,
                            this.dblclick,
                            (_this$nodes = this.nodes) === null ||
                                _this$nodes === void 0
                                ? void 0
                                : _this$nodes.map(function (node) {
                                      return html(
                                          ...
                                          _this2.scale(node.left),
                                          _this2.scale(node.top),
                                          _this2.scale(node.width),
                                          _this2.scale(node.height)
                                      );
                                  }),
                            this.viewport.left,
                            this.viewport.top,
                ...
                },
                {
                    ...
                    value: function dblclick(e) {
                        ...
                        var x =
                            (e.clientX - box.left) / (this.size * this.ratio);
                        var y =
                            (e.clientY - box.top) / (this.size * this.ratio);
                        (_this$point = this.point) === null ||
                        _this$point === void 0
                            ? void 0
                            : _this$point.call(this, x, y);
                    },
                },
                {
                    kind: "method",
...
function _decorate$1(decorators, factory, superClass, mixins) {
    ...
    var decorated = api.decorateClass(
        _coalesceClassElements$1(r.d.map(_createElementDescriptor$1)),
        decorators
    );
    api.initializeClassElements(r.F, decorated.elements);
    return api.runClassFinishers(r.F, decorated.finishers);
...
function _getDecoratorsApi$1() {
    _getDecoratorsApi$1 = function _getDecoratorsApi() {
        return api;
    };
    var api = {
        elementsDefinitionOrder: [["method"], ["field"]],
        ...
        toElementFinisherExtras: function toElementFinisherExtras(
            ...
            var element = this.toElementDescriptor(elementObject);
            var finisher = _optionalCallableProperty$1(
                elementObject,
                "finisher"
            );
            var extras = this.toElementDescriptors(elementObject.extras);
...
function _coalesceClassElements$1(elements) {
    ...
    for (var i = 0; i < elements.length; i++) {
        ...
        if (
            ...
            if (
                _isDataDescriptor$1(element.descriptor) ||
                _isDataDescriptor$1(other.descriptor)
            ) {
            ...
            d: [
                ...
                },
                {
                    ...
                    value: function disconnectedCallback() {
                        ...
                        _get(
                            _getPrototypeOf(RefElement.prototype),
                            "disconnectedCallback",
                            this
                        ).call(this);
                    },
                },
                {
                    ...
                    value: function handlePointerDown() {
                        ...
                        var originalElementsFromPoint =
                            this.originalElementsFromPoint;
                        ...
                        document.elementsFromPoint = function (x, y) {
                            ...
                            while (shadowRoot) {
                                ...
                                d++;
                                shadowElements =
                                    innerElements.concat(shadowElements);
                                shadowRoot =
                                    (_innerElements$ = innerElements[0]) ===
                                        null || _innerElements$ === void 0
                                        ? void 0
                                        : _innerElements$.shadowRoot; // Only check the shadow root of the first element
                                if (d > 5) break;
                            }
                            return Array.from(
                                new Set(shadowElements.concat(elements))
                            );
                        };
                    ...
                    value: function handlePointerUp() {
                        ...
                        setTimeout(function () {
                            document.elementsFromPoint =
                                _this2.originalElementsFromPoint;
                        }, 0);
    ...
    _createClass(LitPlugin, [
        {
            ...
            value: function setParent(scope) {
                var _this2 = this;
                _get(
                    _getPrototypeOf(LitPlugin.prototype),
                    "setParent",
                    this
                ).call(this, scope);
